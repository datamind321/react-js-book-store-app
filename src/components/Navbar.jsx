...
const Navbar = () => {
  return (
    ...
    <nav className='p-4 mx-8'> 
     ...
     <div>
        <h1 className='text-gray-800 hover:text-gray-950 text-2xl font-bold mr-10 cursor-pointer'>BookSpy <span className='font-semibold text-sm'>E-Book-Store</span></h1>
     </div>
